...
// If we are deep in directories, adjust BASE_URL dynamically or hardcode to '/' if proxy
// For a simple XAMPP/Docker setup, we can define BASE_URL relative to the project root.
// We will use absolute paths starting with '/'. If deployed in a subfolder in XAMPP, this needs adjustment.
// Let's use a dynamic approach to find the root.
$script_name = $_SERVER['SCRIPT_NAME'];
$script_dir = dirname($script_name);
// Assuming the root of the project is where index.php is.
// If someone accesses /pages/dashboard.php, script_dir is /pages
// Standardize slashes and casing for absolute paths to ensure reliable matches (especially on Windows)
